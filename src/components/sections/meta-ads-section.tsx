            ...
            <div className="max-w-7xl mx-auto px-4 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <ul className="space-y-4 font-mono text-sm text-white/80">
                        <li className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-neon rounded-full shadow-[0_0_10px_theme(colors.neon.DEFAULT)]" />
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute -top-4 -right-4 md:-top-8 md:-right-8 bg-surface-200 border border-white/10 p-3 md:p-4 rounded-lg shadow-xl" style={{ transform: "translateZ(60px)" }}>
                            <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                                <TrendingUp className="w-4 h-4 md:w-5 md:h-5 text-neon" />
                                <span className="text-[10px] md:text-xs uppercase text-white/40 tracking-wider">ROAS</span>
                            </div>
                            <div className="text-xl md:text-2xl font-mono text-white font-bold">4.82x</div>
                        </div>

                        <div className="absolute -bottom-2 -left-2 md:-bottom-4 md:-left-4 bg-surface-200 border border-white/10 p-3 md:p-4 rounded-lg shadow-xl" style={{ transform: "translateZ(40px)" }}>
                            <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                                <DollarSign className="w-4 h-4 md:w-5 md:h-5 text-cobalt" />
                                <span className="text-[10px] md:text-xs uppercase text-white/40 tracking-wider">CPA</span>
                            </div>
                            <div className="text-xl md:text-2xl font-mono text-white font-bold">$18.40</div>
                        </div>

                        {/* Main Dashboard UI Mockup */}
                        <div className="h-full w-full bg-surface-300/30 rounded border border-white/5 overflow-hidden flex flex-col mt-4 md:mt-0">
